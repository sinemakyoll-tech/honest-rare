    ...
    annotations: [
      {
        ...
        body: '"What you bring home, is who you are." — before the user sees a single product, the platform has already defined its worldview. This is not a tagline; it is a filter. Only users who resonate with this philosophy will proceed, resulting in a higher-intent, higher-loyalty audience.',
      },
      {
        dot: { x: 20, y: 52 },
        label: 'Editor\'s Choice',
        title: 'Curated Narrative',
        body: 'The Editor\'s Choice format places a single featured recipe in full visual focus — large image, minimal text, maximum atmosphere. This signals that H&R is not aggregating content, it is making deliberate editorial decisions. Trust is built through curation, not volume.',
      },
      {
        dot: { x: 55, y: 82 },
        label: 'Weekly Picks',
        title: 'Personalised Discovery',
        body: '"This week\'s picks for you" introduces a personalisation layer within an editorial frame. Cocktails, recipes, and seasonal content presented as a curated row — turning browsing into a habit and the platform into a destination users return to weekly.',
      },
    ],
  },
  {
